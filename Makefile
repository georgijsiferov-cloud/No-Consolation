...
OPTIONS := -masm=intel -Wall -I include -fexceptions -DWIN32_LEAN_AND_MEAN
...
coffeeldr:
	$(CC_x64) -c CoffeeLdr.c -o dist/CoffeeLdr.x64.o $(OPTIONS)
	$(STRIP_x64) --strip-unneeded dist/CoffeeLdr.x64.o